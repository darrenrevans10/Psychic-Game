...
//create a reset function to set back to defualt after winning or guesses are empty
reset = function() {
  guessesLeft = 9;
  guessesSoFar = [];
...
document.onkeyup = function(event) {
  ...
  // the alphabet, and not anything else
  ...
  var html = "<p><h1>The Psychic Game</h1></p>" + "<p><h4>Guess what letter I'm thinking of</h4></p>" + "<p><h4>Wins: " + 
  wins + "</h4></p>" + "<p><h4>Losses: " + losses + "</h4></p>" + "<p><h4>Guesses Left: " + guessesLeft + "</h4></p>" + 
